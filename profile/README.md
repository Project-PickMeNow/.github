...
| 게임 | 설명 |
| :---: | :--- |
| 🎡 **룰렛** | 원판을 돌려 당첨 하나를 뽑아요 |
| 🗳️ **투표하기** | 다 같이 투표해 최다 득표를 정해요 (실시간 집계 · 공동 1위 지원) |
| 🎫 **제비뽑기** | 제비를 뽑아 꽝을 피해요 (제비 수 · 꽝 개수 설정) |
| 🔢 **순서 정하기** | 항목을 무작위 순서로 줄 세워요 |
| 🪜 **사다리타기** | 사다리를 타고 내려가 짝을 정해요 |
| 🎈 **풍선 터뜨리기** | 돌아가며 펌프하다 터뜨린 사람이 걸려요 (턴제) |

<div align="center">
  <!-- 각 게임 데모 이미지/GIF 첨부 -->
  <!-- <img src="이미지_링크" width="32%" alt="룰렛" /> <img src="이미지_링크" width="32%" alt="투표하기" /> <img src="이미지_링크" width="32%" alt="제비뽑기" /> -->
  <!-- <img src="이미지_링크" width="32%" alt="순서 정하기" /> <img src="이미지_링크" width="32%" alt="사다리타기" /> <img src="이미지_링크" width="32%" alt="풍선 터뜨리기" /> -->
</div>
